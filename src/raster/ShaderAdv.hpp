...
public:
    ...
    Raster::Color phone_shader(const Obj::Triangle* triangle,
        const Raster::Color& fill_color,
        const Eigen::Vector3f bc_coord,
        const Raster::Color& texture_color){
    ...
    void shade(const Obj::ObjSet* obj,
        ...
        *z_p = z;
        ...
        Raster::Color result_color = this->phone_shader(triangle, fill_color, bc_coord, texture_color);
